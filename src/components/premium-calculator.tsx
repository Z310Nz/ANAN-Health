  ...
  const methods = useForm<PremiumFormData>({
    ...
    defaultValues: {
      ...
      riders: [
        ...
        { name: 'Care for Cancer', category: 'ชดเชยโรคร้ายแรง', type: 'input', selected: false, amount: undefined },
        { name: 'Health Cancer', category: 'ชดเชยโรคร้ายแรง', type: 'input', selected: false, amount: undefined },
        { name: 'Multi-Pay CI Plus + Total care', category: 'ชดเชยโรคร้ายแรง', type: 'input', selected: false, amount: undefined },
        { name: 'CI Plus', category: 'ชดเชยโรคร้ายแรง', type: 'input', selected: false, amount: undefined },
        { name: 'CI Top Up', category: 'ชดเชยโรคร้ายแรง', type: 'input', selected: false, amount: undefined },
        { name: 'TPD', category: 'ชดเชยโรคร้ายแรง', type: 'input', selected: false, amount: undefined },
        { name: 'AI/RCC', category: 'ชดเชยอุบัติเหตุ', type: 'input', selected: false, amount: undefined },
        { name: 'ADD/RCC', category: 'ชดเชยอุบัติเหตุ', type: 'input', selected: false, amount: undefined },
        { name: 'ADB/RCC', category: 'ชดเชยอุบัติเหตุ', type: 'input', selected: false, amount: undefined },
      ],
    },
  });
